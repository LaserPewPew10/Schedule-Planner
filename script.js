...
// the complete button targets the element via attributs that we add and when pressed will remove the li item/ pink banner and text

// i would instead like the banner when clicked, activate into a text area, which will allow the user to type in text
// which will be saved once the user presses the button on the side.
